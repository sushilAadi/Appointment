...
// Animated grainy-gradient WebGL background (React Bits' "Grainient",
// JS+CSS variant) — hand-integrated from the provided source rather than
// via the shadcn/react-bits CLI, since this project deliberately has no
// Tailwind/shadcn tooling (plain CSS design-token system throughout). The
// shader/render logic below is unchanged from upstream; only the styling
// hook-up (className -> globals.css, not a separate Grainient.css) and
// TypeScript typing are adapted to fit this codebase.
